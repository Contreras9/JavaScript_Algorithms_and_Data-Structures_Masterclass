// Write a function which takes in a string and returns cpunts of each character in the string.
...
function charCount(str) {
   ...
   // loop over string, for each character...
      ...
      // if the character is a number/letter AND not in object, add it to object and set value to 1
